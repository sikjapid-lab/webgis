// پراکسی Serverless برای دریافت داده زنده ADS-B از adsb.lol
// دلیل وجود این فایل: فراخوانی مستقیم adsb.lol از مرورگر با محدودیت CORS و
// نرخ درخواست مواجه می‌شود؛ این تابع به‌عنوان واسط بین برنامه (index.html) و
// سرور adsb.lol عمل می‌کند و پاسخ را روی CDN ورسل به‌مدت کوتاهی کش می‌کند.
